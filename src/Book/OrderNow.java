...
public class OrderNow extends JFrame {
    ...
    private List<Book> bookiteams;
    int quantity;
    int orderId;

    Conn conn = new Conn();

    public OrderNow(double totalprice, List<Book> bookiteams, int quantity) {
        frame = new JFrame();

        this.bookiteams = bookiteams;
...
// Total Amount
        ...
        checkoutButton.addActionListener(e -> {
            ...
            String shippingAddress = shippingAddressLabel.getText();
            ...
            try {
                ...
                orderId = conn.insertOrder(Conn.user, name, email, totalprice, shipmentStatus);
                ...
                for (Book book : bookiteams) { // Iterate through active cart items
//                    Book book = conn.retrieveBookById(cartItem.getBookid());

                    double bookPrice = book.getPrice();
                    int bookId = book.getBookid();
                    conn.insertOrderDetails(orderId, bookId, this.quantity, bookPrice);
                }
