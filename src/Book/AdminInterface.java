...
// JButton for Logout
    ...
    private void displayBooks(List<Book> books) throws MalformedURLException {
        ...
        int panelHeight = 335; // Height of each panel
       ...
       int row = 0; // Row counter
        ...
        for (Book book : books) {
            if (book.getStatus().equals("Active")) {
                ...
                imageLabel.setBounds(5, 2, 190, 240);
                ...
                //JLabel stockLabel = new JLabel("Stock: " + book.getStock() + " units");
                ...
                JButton hidebookButton = new JButton("Hide");
                hidebookButton.setBounds(105, 295, 80, 30);
                hidebookButton.setFocusable(false);
                hidebookButton.setBackground(Color.BLACK);
                hidebookButton.setForeground(Color.WHITE);
                hidebookButton.setBorder(BorderFactory.createLineBorder(new Color(15,15,15)));
                ...
                panel.addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        ...
                        try {
                            frame.dispose();
                            new AdminBookdetail(book); // Assuming BookDetails class takes a Book object as parameter
